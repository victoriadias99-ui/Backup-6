...
export default function Hero() {
  ...
  const slides = [
    {
      id: 1,
      image: "/banner-1.png",
      imageMobile: "/banner-1-mobile.png",
      title: "Banner 1",
    ...
    },
    {
      id: 2,
      image: "/banner-2.png",
      imageMobile: "/banner-2-mobile.png",
      title: "Banner 2",
      position: "object-center"
    },
    {
      id: 3,
      image: "/banner-3.png",
      imageMobile: "/banner-3-mobile.png",
      title: "Banner 3",
      position: "object-center"
    },
    {
      id: 4,
      image: "/banner-4.png",
      imageMobile: "/banner-4-mobile.png",
      title: "Banner 4",
      position: "object-center"
    }
  ];
  ...
  return (
    <section className="relative w-full md:-mt-20 overflow-hidden bg-white aspect-[376/161] md:aspect-[1500/580]">
          ...
          >
            <div className="w-full h-full relative">
              ...
              <img
                src={slide.image}
                alt={slide.title}
                className={`w-full h-full object-contain ${slide.position} hidden md:block`}
                referrerPolicy="no-referrer"
                decoding="async"
                loading={index === 0 ? 'eager' : 'lazy'}
              />
