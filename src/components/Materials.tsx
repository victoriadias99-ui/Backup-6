...
export default function Materials() {
  ...
  return (
    <section id="materiales" className="py-10 bg-white scroll-mt-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 max-w-2xl mx-auto">
            Elegí el material ideal para tu producto.
          </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 relative min-h-[420px]">
          <button 
          ...
          <div className="md:w-1/2 max-w-md animate-in fade-in slide-in-from-right-8 duration-500" key={`content-${activeTab}`}>
            <h3 className="text-3xl font-bold text-gray-900 mb-4">{currentMaterial.title}</h3>
